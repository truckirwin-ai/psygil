# Psygil Demo Video Script (Final v10)
**Duration:** 2:55
**Voice:** Eric (American, conversational) via ElevenLabs eleven_multilingual_v2
**Pronunciation:** Psygil = "Sidgel"

---

| Time | Shot | Screenshot | Narration |
|---|---|---|---|
| 0:00 | Title card | Psygil logo | *(3s silence)* |
| 0:03 | Dashboard | Kanban board | This is Sidgel. Your full caseload at a glance. Cases organized by stage, moving through the pipeline as you work. |
| 0:10 | New Case | Intake wizard | Creating a new case takes about two minutes. Enter the patient info, referral details, and evaluation type. Sidgel handles the rest. |
| 0:18 | Onboarding | Background tab | The intake captures everything: demographics, family history, medical history, substance use, legal context. Clinical notes on the right, saving as you type. |
| 0:27 | Medical | Medical history | Medical history, head injuries, medications. All structured for the report. Next, testing. |
| 0:33 | Testing | Battery table | Your test battery in one view. PCL-R, HCR-20, SARA, all scored with validity flags. |
| 0:39 | Order Measures | Instrument dropdown | Order Measures gives you access to 43 instruments. Forensic, neuropsych, clinical, effort testing. Add whatever your practice needs. |
| 0:48 | Score Detail | HCR-20v3 popup | Hover any instrument for the full detail card. Scale scores, elevation flags, risk rating, and a clinical recommendation, all structured and ready for your report. |
| 0:58 | Interviews | Filled transcript | Moving on to interviews. Record sessions with live transcription running entirely on your machine. No cloud. Import Zoom transcripts. Every session tracked with clinical notes. |
| 1:09 | Diagnostics | 3 conditions | Now, diagnostics. Three conditions identified from your data. The AI suggests. You decide. |
| 1:15 | Render | ASPD confirmed | Confirm a diagnosis. |
...
| 2:06 | Writing Samples | 19 files | Upload your past reports and Sidgel learns your writing voice: sentence length, vocabulary, formality, clinical terminology. Reports read like you wrote them. And every uploaded sample is stripped of PHI locally before analysis. No patient data is ever transmitted. |
| 2:24 | Templates | 7 built-in | Seven built-in report templates covering CST, custody, risk, fitness for duty, PTSD, ADHD, and malingering. Or upload your own. |
| 2:34 | Analytics | 6 charts | Finally, your practice analytics. Pipeline distribution, evaluation types, active versus complete, workload balance, monthly volume, and stage throughput with bottleneck detection. |
| 2:45 | Closing | Analytics | Sidgel. Write better reports in a fraction of the time. The doctor always diagnoses. Try it free at sidgel dot com. |
| 2:52 | End card | psygil.com | *(5s silence)* |
