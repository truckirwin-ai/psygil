...
>
> Psygil's Ingestor agent reads every document the clinician has
> provided: referral letters, prior evaluations, medical records, police
> reports. It produces a structured summary the clinician can review
...
> intake, records, test results, interview notes. It proposes an
...
latency and how long the Diagnostician, Writer, and Editor take. The
