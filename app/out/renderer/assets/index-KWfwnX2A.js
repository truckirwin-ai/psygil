...
const LOGO_SVG = /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "22", height: "22", viewBox: "0 0 100 100", style: { flexShrink: 0 }, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "50,5 15,30 15,75 50,95 85,75 85,30", fill: "#E8650A" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "50,5 15,30 50,50 85,30", fill: "#F5A623" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "15,30 15,75 50,50", fill: "#D45A00" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "85,30 85,75 50,50", fill: "#D45A00" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "35,38 35,52 45,48 45,34", fill: "#1a1a2e" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "55,34 55,48 65,52 65,38", fill: "#1a1a2e" }),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarIcon, { label: "Settings", children: "⚙" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarIcon, { label: "Theme", onClick: onCycleTheme, children: "☀" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "var(--text-secondary)", whiteSpace: "nowrap" }, children: "Dr. Irwin" })
            ]
          }
        )
      ]
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 16 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "LLM: Claude Sonnet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "PHI: UNID Redaction ✓" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Storage: Local" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 16 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "12 active cases" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "v0.1.0-alpha" })
        ] })
      ]
    }
  );
...
function getInstrumentsForEvalType(evalType) {
...
function WelcomeContent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", color: "var(--text-secondary)" }, children: [
...
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, fontWeight: 600, color: "var(--text)" }, children: title }),
        onEdit != null && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onEdit, style: editButtonStyle, children: "Edit" })
      ]
    }
  );
}
...
function HSplitter({ onResize, onResizeEnd }) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            style: {
              flex: contextHeight == null ? 1 : void 0,
              height: contextHeight ?? void 0,
              display: "flex",
              flexDirection: "column",
              overflow: "hidden"
            },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(ContextSection, { title: "Quick Actions", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: "Open Evaluation Report"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(HSplitter, { onResize: handleResize }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
...
function mapToIpcReferralType(mode, partyType) {
...
function SetupModal({ isOpen, onClose, onWorkspaceSet }) {
  const [currentPath, setCurrentPath] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(false);
  const [status, setStatus] = reactExports.useState({ kind: "idle" });
  reactExports.useEffect(() => {
    if (!isOpen) return;
    setStatus({ kind: "idle" });
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 14, fontWeight: 600, color: "var(--text)" }, children: "Workspace Setup" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      "aria-label": "Close",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px 20px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "var(--text-secondary)", marginBottom: 20, lineHeight: 1.6 }, children: "Choose the root folder where Psygil stores your case files, documents, and reports. This folder will be created if it doesn't exist." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4, textTransform: "uppercase", letterSpacing: 1 }, children: "Current Workspace" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: currentPath ? "var(--text)" : "var(--text-secondary)", fontFamily: "monospace", wordBreak: "break-all" }, children: currentPath ?? "Not configured" })
                  ]
                }
              ),
              status.kind !== "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    padding: "8px 12px",
...
function App() {
  ...
  const handleLeftResize = reactExports.useCallback((delta) => {
    setLeftWidth((prev) => Math.max(MIN_COL, prev + delta));
  }, []);
  const handleLeftResizeEnd = reactExports.useCallback(() => {
    setLeftWidth((w) => {
      localStorage.setItem(STORAGE_KEY_LEFT_W, String(w));
      return w;
    });
  }, []);
  const handleRightResize = reactExports.useCallback((delta) => {
    setRightWidth((prev) => Math.max(MIN_COL, prev - delta));
  }, []);
  const handleRightResizeEnd = reactExports.useCallback(() => {
    setRightWidth((w) => {
